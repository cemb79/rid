...
public final class WebPaths {
	...
	public static final String DELIVERY_ORDER_MANAGEMENT = "/deliveryOrders/management/{doId}";
	public static final String DELIVERY_ORDER_HISTORY = "/deliveryOrders/history/{doId}";
